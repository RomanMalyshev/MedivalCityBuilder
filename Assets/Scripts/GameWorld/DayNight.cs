    ...
    public class DayNight : MonoBehaviour
{
    ...
    private DayNightComponent _dayNightComponent;
    ...
    private void Start()
    {
        ...
        var query = _entityManager.CreateEntityQuery(typeof(DayNightComponent));
        _entity = query.GetSingletonEntity();
        _dayNightComponent = _entityManager.GetComponentData<DayNightComponent>(_entity);
    }
    ...
    private void Update()
    {
        ...
        _dayNightComponent.TimeOfDay = _timeOfDay;
        _entityManager.SetComponentData(_entity,_dayNightComponent);
    }
